...
program main
    ...
    rX(1) = 1.d0; rY(1) = 1.d0; rZ(1) = 1.d0;
    rX(2) = 2.d0; rY(2) = 2.d0; rZ(2) = 2.d0;
    rX(3) = 3.d0; rY(3) = 3.d0; rZ(3) = 3.d0;

    q(1) = -1.d0; q(2) = 1.d0; q(3) = 1.d0;
...
!  rcpcut=rcpcut*1.05d0*tpi;  rcpct2=rcpcut**2;  r4alpsq=-0.25d0/alpha**2
 ...
 !         if (rksq .le. rcpct2 ) then
              ...
              non_cpetot = non_cpetot + pentical_mesh(j,k,l)
 !         end if
      end do
    end do
  end do
  ...
  non_cpetot = non_cpetot*qtotsq
  eng_non_neu = real(non_cpetot)*engcoeffi
